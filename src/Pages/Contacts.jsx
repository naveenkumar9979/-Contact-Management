...
const Contacts = () => {
    ...
    <div className="m-4">
        <button className="rounded-full bg-blue-600 custom-btn-style p-2 text-2xl">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return                        <div key={el.id} className="rounded-lg shadow-md m-4 p-4 text-white shadow-opacity-130" style={{ backgroundColor: '#2B3950' }}>
                        <div onClick={() => togglePopup(el)} className="w-3/4 m-auto  ">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                <button className="rounded p-2 bg-red-500 text-white flex items-center">
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 576 512" 
        className="h-4 w-4 mr-2" // Adjust size and margin as needed
    >
        <path 
     d="M402.6 83.2l90.2 90.2c3.8 3.8 3.8 10 0 13.8L274.4 405.6l-92.8 10.3c-12.4 1.4-22.9-9.1-21.5-21.5l10.3-92.8L388.8 83.2c3.8-3.8 10-3.8 13.8 0zm162-22.9l-48.8-48.8c-15.2-15.2-39.9-15.2-55.2 0l-35.4 35.4c-3.8 3.8-3.8 10 0 13.8l90.2 90.2c3.8 3.8 10 3.8 13.8 0l35.4-35.4c15.2-15.3 15.2-40 0-55.2zM384 346.2V448H64V128h229.8c3.2 0 6.2-1.3 8.5-3.5l40-40c7.6-7.6 2.2-20.5-8.5-20.5H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V306.2c0-10.7-12.9-16-20.5-8.5l-40 40c-2.2 2.3-3.5 5.3-3.5 8.5z" fill="#fff" />
    ...
    className="rounded p-2 flex items-center bg-red-600 text-white"
>
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 448 512" 
    ...
    >
        <path 
            d="M135.168 401.6C136.802 419.001 151.013 432 168.555 432H279.445C296.987 432 311.198 419.001 312.832 401.6L326.665 208H121.335L135.168 401.6zM432 80H312L298.945 55.5C295.074 47.407 287.073 42 278 42H170C160.927 42 152.926 47.407 149.055 55.5L136 80H16C7.163 80 0 87.163 0 96C0 104.837 7.163 112 16 112H32L46.12 416.344C48.305 462.097 89.211 496 135.168 496H312.832C358.789 496 399.695 462.097 401.88 416.344L416 112H432C440.837 112 448 104.837 448 96C448 87.163 440.837 80 432 80zM170 64H278L291.055 88.5H156.945L170 64zM128.128 416L113.316 208H334.684L319.872 416H128.128z"
        />
    </svg>
    Delete
</button>
